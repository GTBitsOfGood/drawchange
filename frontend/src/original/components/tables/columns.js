const full_name = { id: 'full_name', Header: 'Full Name',
  accessor: d => (`${d.bio.first_name}  ${d.bio.last_name}`)
};
const age = { id: 'age', Header: 'Age', maxWidth: 50,
  accessor: d => {
...
const criminal_history = { id: 'criminal_history', Header: 'Criminal History',
...
const referral = { id: 'referral', Header: 'Referral', maxWidth: 100,
  accessor: d => {
    let referral = '';
