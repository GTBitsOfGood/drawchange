    ...
    return (
      <Col md={6} mdOffset={3}>
        ...
        <Form model="forms.event" onSubmit={v => console.log(v)}>
          ...
          <Control required component={Text} model=".link" label="Link to Sign Up" type="text" min={1} placeholder = "https://signup.com/client/invitation2/secure/12345/false#/invitation"
          errors = {{
            isRequired: (val) => !val
          }}/>
