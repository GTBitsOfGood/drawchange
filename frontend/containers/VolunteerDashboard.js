  ...
  render() {
    return (
      <div>
        ...
        <Col smOffset={1} lgOffset={2} style={{backgroundColor: "rgba(255, 255, 255, 1)", paddingTop:"10px", paddingBottom:"20px", paddingLeft:"20px", paddingRight:"20px"}}>
        ...
        <Row>
          <Col md={7} mdOffset={1} style={{backgroundColor: "rgba(255, 255, 255, 1)", paddingTop:"10px", marginTop:"0px"}} smOffset={1} lgOffset={2} lg={4} sm={5} >
            ...
            <Panel header={<h3>Documents</h3>} bsStyle="info">
              ...
              <p>Please click <a target="_blank" href="http://drawchange.org/wp-content/uploads/2015/03/VolunteerHandbook-EmotionalStress.pdf"> here </a> for our manual so you know what to expect and what to do if a situation arises on your volunteer shift.</p>
              <ol>
              ...
              <p>In the interest of child protection and abuse prevention, drawchange™
              has adopted the attached policy concerning interactions with children minors,
              under the supervision and direction of drawchange™ staff and volunteers.
              It is important that staff and volunteers understand the Purpose of this
              document and implement the Prevention Guidelines and Response Procedures
              of this policy. Click <a target="_blank" href="http://drawchange.org/wp-content/uploads/2017/07/childprotectionpolicy.pdf"> here </a>
              to view and download our child protection clause. </p>
            </Panel>
          ...
          <Col sm={5} lg={4} style={{backgroundColor: "rgba(255, 255, 255, 1)", paddingTop:"10px"}}>
