  ...
  render() {
    return (
        <div>
            ...
            {this.isVolunteer && this.props.currentItem ? this.props.currentItem.role === "volunteer" ? <Button bsStyle="primary">Deny</Button> : <Button bsStyle="primary" >Remove</Button> : null}
        </div>
    );
  }
}
