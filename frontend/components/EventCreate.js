...
const EventCreate = () => (
    <Form model = "myForms" >
        ...
        <Control required component={Text} model=".location" label="Location" type="location" />
        <Control required component={Text} model=".description" label="Description" type="description" />
